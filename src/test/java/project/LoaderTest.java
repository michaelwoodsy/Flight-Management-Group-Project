...
//        }
    ...
    public void loadCovidFileTest() throws IOException{
        ...
        Hashtable<String, Covid> covid_list = covidLoader.loadCovidFile("data/covid.dat");
...
//        }
    ...
    public void testCovid() throws IOException {
        ...
        Hashtable<String, Covid> covid_list = covidLoader.loadCovidFile("data/covid_test.dat");
